...
bool buscarLibroCienciaFiccion() {
...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
             case 5: cout << "Buscando..." << endl;   // español
                if(buscarLibroEspanol())
                    cout << "si se encuntra!" << endl;
                else
                    cout << "El libro no se encuntra!" << endl;
            break;
             case 6: cout << "Buscando..." << endl;  // ciencia_ficcion
                if(buscarLibroCienciaFiccion())
                    cout << "si se encuntra!" << endl;
                else
                    cout << "El libro NO se encuentra" << endl;
            break;
